[README (6).md](https://github.com/user-attachments/files/29062544/README.6.md)
...
- **CNN Model 1** uses two convolutional layers with max pooling; achieved **87.38% accuracy**
- **CNN Model 2** uses four convolutional layers with six fully connected layers; achieved **89.62% accuracy**
